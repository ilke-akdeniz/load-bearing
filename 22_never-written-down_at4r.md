...
Only the second is one of [chapter 03](03_forces_f4m5.md)'s seven, which is [chapter 19](19_force-map-method_r37x.md)'s point that the seven are not a closed list. What makes both of them Forces is that each is checkable, and each says what would have to change for the answer to change.
