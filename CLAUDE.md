...
[Chapter 07](07_scale_637f.md)'s Amdahl section works because a hundred-minute report with twenty un-splittable minutes makes the ceiling obvious before any formula appears — the name then labels something already understood rather than gating it.
...
[Chapter 08](08_change_rjf9.md) explained Conway's Law twice without reading Conway.
...
[Chapter 14](14_principle-loses-scope_b86v.md) got the Pike material from a third-party transcript, read in excerpts, and then failed in a way excerpt-reading makes almost inevitable.
...
Three times while finishing [chapter 14](14_principle-loses-scope_b86v.md), a single word caught in review was doing the same wrong job elsewhere, and the one-site fix would have left the rest.
...
This has come up three times — [chapters 09](09_what-a-pattern-is-for_3xzc.md), 15 and 19 — and the fix costs one extra commit.
