...
And he is explicit that much of what people argue about is not the kind of thing that has a right answer — which is [chapter 01](../../01_the-five-kinds_cjx4.md)'s subject stated by someone with every reason to claim otherwise.

## Already used

**[Chapter 14](../../14_principle-loses-scope_b86v.md)** takes the concurrency section: Ousterhout's *threads are bad*, whose situation was pthreads in a particular kind of program and which Google banned company-wide anyway; and Pike's own admission that the concurrency use cases were server software, that the team should have said so, and that the confusion between concurrency and parallelism probably drove some programmers away.
See decisions 72 and 73.

**[Chapter 20](../../20_idioms_7nkn.md)** takes both pieces owed to it: interfaces colouring their designers' thinking, as the boundary on 21's claim, and the early compiler in C as the worked deviation.
...
One further line was noticed and left for [chapter 01](../../01_the-five-kinds_cjx4.md), which already owes it a paragraph: Pike lists *using upper case for export* alongside *where the newlines go* as perennial arguments, which is 02's point that tone does not vary with authority.

## Material owed to other chapters

### [Chapter 01](../../01_the-five-kinds_cjx4.md) — confidence does not track the kind of claim
...
[Chapter 01](../../01_the-five-kinds_cjx4.md)'s mechanism is that tone does not vary with authority, so a Style question and a Law arrive sounding alike.
...
### [Chapter 08](../../08_change_rjf9.md) — a compatibility promise, priced by the person who made it
...
[Chapter 08](../../08_change_rjf9.md) owns *once published, it is forever* and the add-only rule.
...
### [Chapter 20](../../20_idioms_7nkn.md) — an Idiom that limited the people who invented it
...
[Chapter 20](../../20_idioms_7nkn.md) takes Idioms seriously rather than dismissing them.
...
### [Chapter 20](../../20_idioms_7nkn.md) — a deviation from Idiom, defended by Forces
...
[Chapter 20](../../20_idioms_7nkn.md)'s contents already promise *when to deviate, and how to pay for it — declare it, document the reason, keep it narrow*.
...
### [Chapter 12](../../12_missing-language-features_esqm.md) — lower confidence, and worth checking before use
...
This is adjacent to [chapter 12](../../12_missing-language-features_esqm.md) rather than in it.
[Chapter 12](../../12_missing-language-features_esqm.md) is about patterns that dissolve when the language has the feature; this is about a feature that creates work the programmer must then carry, which is closer to an inverse.
Do not force it. If it fits anywhere it may be [chapter 19](../../19_six-profiles_dnkz.md)'s distributed-services section, or nowhere.

**2026-08-23: nowhere, on the evidence of [chapter 19](../../19_six-profiles_dnkz.md) being drafted.** Coloured functions is an observation about what a language feature costs its users, not about a domain's force profile, and 20's distributed section is almost entirely [chapter 06](../../06_distribution_49yh.md)'s material cited. Forcing it in would have been a fifth thing in a section that adds one. Leaving it recorded here in case [chapter 20](../../20_idioms_7nkn.md) or 23 wants it.

### [Chapter 04](../../04_structure_agjy.md) — background rather than evidence
...
[Chapter 04](../../04_structure_agjy.md) owns dependency structure and does not need this to make its argument.
...
|---|---|---|---|
| Ousterhout's ban; the concurrency admission | 14 | a section | **done** |
| Confidence does not track the kind of claim | 01 | a paragraph | owed, chapter at draft |
| Compatibility priced by the person who paid it | 08 | a passage | owed, chapter at draft |
| Interfaces coloured their own designers' thinking | 20 | a section | **done** |
| The compiler in C, as a declared deviation | 20 | a passage | **done** |
| async/await and coloured functions | 13 or 20 | uncertain | check the fit first |
| The 45-minute build | 04 | background | probably not needed |

## The decision on chapters already at draft

**Record now, apply when the chapter is next open.**
[Chapters 01](../../01_the-five-kinds_cjx4.md), 04, 08, and 12 are at **draft**, and the additions above wait.
...
Material of this kind is strongest when the chapter is live, because the argument can be shaped around it — [chapter 14](../../14_principle-loses-scope_b86v.md)'s use of this source worked for that reason, and a quotation bolted onto a finished chapter is the decoration the register rules exclude.
