...
**Corrected 2026-08-26.** This gap previously also named the dependency-injection container, which is no longer true: [chapter 02](../../02_the-five-kinds_cjx4.md) classifies it as an Idiom and separates it from the Principle it travels with, and [chapter 21](../../21_idioms_7nkn.md) gives its conditions.
