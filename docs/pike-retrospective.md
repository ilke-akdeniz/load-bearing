...
Working document, in the shape of `docs/ai-material.md` and `docs/speculative-abstraction.md`.
...
And the precedent already exists and worked: `docs/ai-material.md` holds material owed to 02 and 03 in exactly this way.
