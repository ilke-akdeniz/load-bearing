...
| Scope is carried only where named | 15 | A compressed principle carries the extent of its key words only where the sentence names it; where it does not, the reader supplies it and the widest reading is the only one available | "the scope does not travel (Ch. 15)" |
