...
| Folk remedy | 23 | Advice applied far outside the context it was made for, which stays misapplied because nobody rebuilds its scope — the author's term, not standard. A corpus default is the purest instance: nobody rebuilds the scope because nobody knows one existed | "a folk remedy (Ch. 23)"; 15 hands it over |
