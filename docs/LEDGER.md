...
| The instruction travels, the Cons list does not | 16 | Riel's 2.9 qualifies *related* data and gives a cohesion test at 4.6; the reengineering pattern names behaviour reaching client data and its cost, a dependency from provider back to client. The five words carry the instruction alone | "the Cons list stayed behind (Ch. 16)" |
