...
| The record is not a design | at4r | What an entry preserves is which decisions were forced and which were chosen — same code either way, and only a forced decision says what would have to change for it to be revisited | "forced or chosen" |
