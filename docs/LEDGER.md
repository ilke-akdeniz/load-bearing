...
| Subject and profile are independent axes | 20 | Unrelated subjects can share a force profile — flight simulator, video encoder, trading loop; and one subject can hold opposite profiles — two sales systems whose concurrency readings are nothing alike. The profile predicts the inversion, the subject predicts almost nothing | "subject and profile (Ch. 20)" |
| Profile inversions | 20 | Each profile's dominant force inverts some standard advice | cite 20 |
