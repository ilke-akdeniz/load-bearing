...
| The unpacking buys recovery, not transmission | b86v | Martin's paper and Pike's forty seconds both stayed where they were; medium decides whether the scope can be reached, never whether it travels, and at4r's corpus default is where there is nothing to reach | cite |
