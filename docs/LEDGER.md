...
| An AI coding agent cannot see your Forces | f4m5 | Forces are facts about your situation; an agent has the prompt, so the groundwork is skipped by construction | cite; argument in `docs/pending-tasks/ai-material.md` |
