...
| Corpus monoculture | cjx4 | A model has one training distribution and cannot acquire a second, so 01's prescribed cure is unavailable to it | cite; argument in `docs/pending-tasks/ai-material.md` |
