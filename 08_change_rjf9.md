...
That is a different use of the constraint from the one this section has described. Above, it arrives with your first user and then cannot be got rid of. Here somebody adopted it early, at a point where they could still have declined, and counted what it prevents as part of what they were buying. The deprecated declarations are one side of that trade, and the features it stopped are the other. [-- this seems like an intersting point and good addition but I read it two times and couldn't get the exact meaning. So Go still supports 1.0 and it is a direct contrast of what we haveseein I get that. But what you mean by "feature-itis" and what is the trade-off here and why that is justified and doesn't contradict our chapter? Needs better wording and clarification.]
