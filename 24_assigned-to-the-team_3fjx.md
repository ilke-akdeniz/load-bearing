...
[Chapter 19](19_force-map-method_r37x.md) owns the method and [chapter 03](03_forces_f4m5.md) owns the Forces themselves. What is added here is that its output is an artifact somebody owns, and that its size varies more than anything else in the list.
