...
**One thing this is not.** It is not more evidence about the proverbs. *Don't communicate by sharing memory* and *concurrency support in the language* are different artifacts, and nothing here says the proverb caused what Pike is describing. What is the same is the mechanism — once diagnosed in someone else's advice, once confessed in his own — and in both cases the wide reading ran for years before anyone wrote the correction. Google's ban outlasted the objection to it; the talk that separated concurrency from parallelism came three years after the launch.
