...
**One kind of contributor sits at the extreme of both halves.** The Force asks how many people must agree and how many will still be here, and generated code answers the second with *none*. It was present for no conversation, keeps nothing between sessions, and arrives at a volume the review step was not sized for. The Forces that would settle the decisions inside it are facts about your situation, held by you, and reach it only to the extent that some prompt happened to carry them.
