...
In one process, both invariants are free. There is one memory space, so a single variable *is* the one instance, and "everyone agrees" is not a question anyone can ask — there is nothing that could disagree.
